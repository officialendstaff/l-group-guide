...
function showPage(page){
  ...
  topPage.classList.remove('show'); framewrap.style.display='block';
  bottomWrap.style.display=(page==='qa'||page==='manual')?'none':'block';
...
document.getElementById('login').addEventListener('submit',e=>{
  e.preventDefault();
  if(document.getElementById('pw').value==='2525'){document.getElementById('error').textContent='';setAuth(true);}
